# Node.js : Logger <img valign="bottom" align="right" height="40px" widht="40px" src="https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png" />


### What is in there
This GitHub repository is just a simple program starter using a logger module.
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-logger
cd nodejs-logger
npm install
node index.js
```
